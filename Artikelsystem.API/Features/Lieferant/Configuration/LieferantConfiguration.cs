...
namespace Artikelsystem.Api.Features.Lieferant.Configuration;

public class LieferantConfiguration : IEntityTypeConfiguration<Models.Entitys.Lieferant>
{
    public void Configure(EntityTypeBuilder<Models.Entitys.Lieferant> builder)
    {
